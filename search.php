<?php require_once 'init.php';
   ...
   if ($s>0) {
      $where.=" AND sub_cat_id='$s' ";
   }
   
   $getArticles=$frontend->getList('articles',$where,5);
 ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="masonry-box post-media">
                             ...
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a href="javascript:void(0);" title=""><?php print $getCat['title']; ?></a></span>
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-list clearfix">
                              <?php 
                              // $getLastArticle=$frontend->getLastArticle();
                                if ($getArticles['totalRow']==0) {
                                    ?>
                                    <div class="alert alert-warning">درباره ای 
                                    <span class="bg-orange text-white p-1" style="border-radius: 5px;"><?php print $title; ?></span>
                                    چیزی  یافت نشد.</div>
                                    <?php

                                }else{
                              while ($articles=$frontend->getRow($getArticles['result'])) {
                              $getCat=$frontend->getGroup($articles['cat_id']);
                              ...
                              ?>
                                ...
                                $frontend->pagination($url,$getArticles['totalPage']);
                                }
                                ?>
